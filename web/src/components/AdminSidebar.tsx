...
const navItems = [
  ...
  {
    label: 'Etiquetar frames',
    href: '/admin/etiquetar',
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.568 3H5.25A2.25 2.25 0 0 0 3 5.25v4.318c0 .597.237 1.17.659 1.591l9.581 9.581c.699.699 1.78.872 2.607.33a18.095 18.095 0 0 0 5.223-5.223c.542-.827.369-1.908-.33-2.607L11.16 3.66A2.25 2.25 0 0 0 9.568 3Z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M6 6h.008v.008H6V6Z" />
...
export default function AdminSidebar() {
  ...
  return (
    <aside className="w-64 bg-gradient-to-b from-slate-900 to-slate-800 min-h-screen flex flex-col fixed left-0 top-0">
      {/* Logo */}
      <div className="px-5 py-5 border-b border-white/10">
        <Link href="/" className="flex items-center gap-2.5">
          ...
          <div>
            <p className="font-bold text-white text-sm">Sponsorship MVP</p>
      ...
      <nav className="flex-1 px-3 py-4 space-y-1">
        <p className="px-3 text-[10px] font-semibold text-slate-500 uppercase tracking-wider mb-2">Principal</p>
        {navItems.map(item => {
        ...
        <div className="pt-4">
          <p className="px-3 text-[10px] font-semibold text-slate-500 uppercase tracking-wider mb-2">Administracion</p>
          <Link href="/admin/users"
            className={`sidebar-link ${pathname === '/admin/users' ? 'active bg-white/10 text-white' : 'text-slate-400 hover:text-white'}`}>
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <div className="px-5 py-4 border-t border-white/10">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-slate-500">Liga 1 Peru</p>
          </div>
        </div>
      </div>
    </aside>
